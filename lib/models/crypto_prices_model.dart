...
//
//     final cryptoPrices = cryptoPricesFromJson(jsonString);

import 'dart:convert';

List<CryptoPrices> cryptoPricesFromJson(String str) => List<CryptoPrices>.from(
    json.decode(str).map((x) => CryptoPrices.fromJson(x)));

String cryptoPricesToJson(List<CryptoPrices> data) =>
...
class CryptoPrices {
  ...
  factory CryptoPrices.fromJson(Map<String, dynamic> json) => CryptoPrices(
        id: json["id"],
        symbol: json["symbol"],
        name: json["name"],
        image: json["image"],
